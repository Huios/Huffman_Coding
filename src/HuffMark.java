...
public class HuffMark {
    ...
    private long  myTotalSavedBytes;
    
    private IHuffProcessor myHuffer;
    private static String SUFFIX = ".hf";
    private static String SUFFIX2 = ".hf.hf";
    private static String SUFFIX3 = ".hf.hf.hf.hf";
    ...
    public void compress(File f) throws IOException{
        ...
        myTotalSavedBytes = myTotalUncompressedBytes - myTotalCompressedBytes;
    ...
    public void doMark() throws IOException{
        ...
        if (action == JFileChooser.APPROVE_OPTION){
            ...
            System.out.printf("total compressed file bytes %d\n", myTotalCompressedBytes);
            System.out.printf("total percent compression %.3f\n",100.0* (1.0 - 1.0*myTotalCompressedBytes/myTotalUncompressedBytes));
            System.out.printf("total bytes saved: %d\n ", myTotalSavedBytes);
            //System.out.printf("total percent saved bytes %.3f\n",100.0* (1.0 - 1.0*myTotalSavedBytes/myTotalUncompressedBytes));
